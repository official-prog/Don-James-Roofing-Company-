    ...
    <section ref={ref} className="relative h-[80vh] min-h-[600px] overflow-hidden flex items-center">
      ...
      <div className="relative mx-auto max-w-7xl px-6 w-full">
        ...
        >
          ...
          <a href="tel:+17022935650" className="mt-8 inline-flex items-center gap-3 rounded-full bg-primary text-primary-foreground px-7 py-4 font-medium hover:shadow-[var(--shadow-glow)] transition-shadow">
            <Phone className="w-4 h-4" /> (702) 293-5650 · Free Estimate
          </a>
        </motion.div>
      </div>
    </section>
